...
function H = perlin_2d(f, Amp, X, Y)
    ...
    N00 = interp2(cpx, cpy, Gx, I0, J0).*U0 + interp2(cpx, cpy, Gy, I0, J0).*V0;
    N01 = interp2(cpx, cpy, Gx, I0, J1).*U0 + interp2(cpx, cpy, Gy, I0, J1).*V1;
    N10 = interp2(cpx, cpy, Gx, I1, J0).*U1 + interp2(cpx, cpy, Gy, I1, J0).*V0;
    N11 = interp2(cpx, cpy, Gx, I1, J1).*U1 + interp2(cpx, cpy, Gy, I1, J1).*V1;
